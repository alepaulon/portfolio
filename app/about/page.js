            ...
            <div className='flex flex-col justify-between items-center lg:items-start m-6'>
                ...
                <span className='flex flex-row'>
                    <div className='m-4 flex flex-col justify-around min-w-[200px] lg:max-w-3xl'>
                        ...
                        <h2 className='pt-4'>Wanna talk with me? Feel free to contact me on my<Link href='https://www.linkedin.com/in/alejopaulon/' target="_blank" className="font-semibold"> LinkedIn</Link>.</h2>
                    </div>
                </span>
            </div>
        </div>
